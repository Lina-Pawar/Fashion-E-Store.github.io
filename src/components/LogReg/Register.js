      ...
      <div>
        ...
        <div className="reg">
          <form className="regform" onSubmit={handleSubmit}>
            ...
            <input className="reginput2" type="text" id="lname" required onChange={(e) => setlname(e.target.value)} placeholder="Last Name"/>
            <br/>
            ...
            <br/>
            <input className="reginput" type="text" id="email" required onChange={(e) => setemail(e.target.value)}/>
            <br/>
            ...
            <br/>
            <input className="reginput" type="text" id="username" required onChange={(e) => setusername(e.target.value)} />
            <br/>
            <label className="reglabel">Password:</label>
            <br/>
            <input className="reginput" type="password" id="password" required onChange={(e) => setpassword(e.target.value)} placeholder="Atleast 8 characters"/>
            <br/>
            <label className="reglabel">Confirm Password:</label>
            <br/>
            <input className="reginput" type="password" id="confirmpassword" required onChange={(e) => setconfirmpassword(e.target.value)} placeholder="Re-enter password"
            />
          <br/>
          <div align="center">
